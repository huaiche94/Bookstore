...
public class BookDaoJdbc implements BookDao {
    ...
    private static final String FIND_BOOKS_BY_NAME =
            "SELECT book.* " +
                    "FROM book, category " +
                    "WHERE category.name = ? AND category.category_id = book.category_id";
    ...
    public List<Book> findRandomByCategoryId(long categoryId, int limit) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding random books by category ID " + categoryId + "with limit = " + limit, e);
        }
    ...
    public List<Book> findBooksByName(String name) {
        List<Book> books = new ArrayList<>();
        try (Connection connection = JdbcUtils.getConnection();
             PreparedStatement statement = connection.prepareStatement(FIND_BOOKS_BY_NAME)) {
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding books by category name" + name, e);
        }
